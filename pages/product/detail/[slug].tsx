...
const ProductDetail = ({ product }: { product: IProduct }) => {
    ...
    if (product)
        return <div className={clsx(' container border border-red-800 p-4 shadow-md max-w-md mx-auto my-4 h-full')}>
            <div className="flex justify-between">
                ...
                <img src={product.imageUrl ?? "/assets/imags/NoImage.png"} className="w-3/5 h-3/5 objec" />
            </div>
                ...
                <div className="flow-root">
                    <ul className="-mb-8">
                        {product.history.map((event, eventIdx) => {
                            ...
                            const updatedDate = event.updatedOn ? new Date(event.updatedOn) : null
                                ...
                                <div className="relative pb-8">
                                    ...
                                    <div className="relative flex space-x-3">
                                        <div>
                                            ...
                                            >
                                                {isRed ? <ThumbDownIcon className="h-5 w-5 text-white" aria-hidden="true" />
                                        ...
                                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                            <div>
                                                <p className="text-sm text-gray-500">
                                                    Price {isRed ? 'increased ' : 'decreased '} from {event.previousprice} to {event.currentprice}.
                                                </p>
                                            </div>
